-- ========================================
-- AI Conversations Tables Setup
-- ========================================
-- Execute this SQL in your Supabase SQL Editor:
-- 1. Go to https://supabase.com/dashboard/project/gqqlqxmiqjzusyivpkzm/sql/new
...
DO $$
BEGIN
    RAISE NOTICE 'AI Conversations tables created successfully!';
    RAISE NOTICE 'You can now use the chat feature to create and manage conversations.';
END $$;
